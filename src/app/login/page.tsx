  ...
  return (
    <main className="min-h-screen flex">
      ...
      >
        ...
        <div>
          <p className="text-blue-300 text-xs">
            © 2026 Mundo Shop. Todos los derechos reservados.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center w-full lg:w-1/2 px-8 sm:px-16 lg:px-20 py-12">
        {/* Mobile logo */}
        <div className="lg:hidden mb-10 -mx-8 sm:-mx-16 -mt-12 px-8 sm:px-16 py-6 mb-8" style={{ backgroundColor: "#00217E" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <p className="text-center text-xs text-gray-400 mt-8">
            ¿No tenés cuenta?{" "}
            <Link href="/register" className="font-semibold hover:underline" style={{ color: "#00217E" }}>
              Registrate
            </Link>
          </p>
        </div>
